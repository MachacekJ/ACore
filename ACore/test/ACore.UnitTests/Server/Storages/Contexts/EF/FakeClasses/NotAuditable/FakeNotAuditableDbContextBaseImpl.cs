...
{
  public DbSet<FakeNotAuditableLongEntity> Fakes { get; set; }
  
  public FakeNotAuditableDbContextBaseImpl(DbContextOptions<FakeNotAuditableDbContextBaseImpl> options, IMediator mediator, ILogger<FakeNotAuditableDbContextBaseImpl> logger) : base(options, mediator, logger)
  {
    RegisterDbSet(Fakes);
  }
