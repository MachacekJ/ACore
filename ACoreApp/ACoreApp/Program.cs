...
using ACoreApp.Client.Configuration.Localization;
...
var aCoreSettings = builder.Configuration.GetSection("ACoreServer").Get<ACoreAppSettings>() ?? throw new NullReferenceException();

// var localizationRepository = new MemoryLocalizationRepository([
//   new ACoreACoreLocalizationItem(typeof(ACoreApp.Client.Configuration.Localization.Contexts.Memory.ResXContext), "Test", 1033, "TestEn"),
//   new ACoreACoreLocalizationItem(typeof(ACoreApp.Client.Configuration.Localization.Contexts.Memory.ResXContext), "Test", 1029, "TestCZ"),
//   new ACoreACoreLocalizationItem(typeof(ACoreApp.Client.Configuration.Localization.Contexts.Memory.ResXContext2), "Test", 1033, "TestEn2"),
//   new ACoreACoreLocalizationItem(typeof(ACoreApp.Client.Configuration.Localization.Contexts.Memory.ResXContext2), "Test", 1029, "TestCZ2"),
// ]);
...
builder.Services.AddACoreApp(b =>
{
  ...
  b.AddLocalizationModule(SupportedLanguage.AllSupportedLanguages.Select(i => i.Name).ToArray(),
    l => { l.AddLocalizationRepositories(localizationRepositories); }
  );

  #endregion

  #region ACoreApp configuration
