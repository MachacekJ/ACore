...
public class AuditSqlStorageImplCacheTests
{
  ...
  private AuditSqlRepositoryImpl CreateAuditSqlStorageImplAsSut(IACoreServerCurrentScope serverCurrentScope, Action<FakeAuditSqlRepositoryImpl>? seedData = null)
  {
    ...
    var res = new FakeAuditSqlRepositoryImpl(dbContextOptions, serverCurrentScope, loggerMocked);
    seedData?.Invoke(res);
    return res;
  }
  ...
  private IACoreServerCurrentScope CreateApp(IServerCache cache)
  {
