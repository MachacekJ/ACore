...
public class EfContextBaseNotAuditableCRUDTests() : EfContextBaseCRUDTests(CRUDEntityTypeEnum.FakeNotAuditableLongEntity)
{
  [Fact]
  public async Task AddNewItemTest()
  {
    ...
    // Arrange
    var serverOptions = new Mock<IACoreServerCurrentScope>();
