...
public class FakeAuditableEfContextBaseImpl : EFContextBase
{
  public DbSet<FakeAuditableEntity> Fakes { get; set; }
  
  public FakeAuditableEfContextBaseImpl(DbContextOptions<FakeAuditableEfContextBaseImpl> options, IACoreServerCurrentScope serverCurrentScope, ILogger<FakeAuditableEfContextBaseImpl> logger) : base(options, serverCurrentScope, logger)
  {
    RegisterDbSet(Fakes);
  }
